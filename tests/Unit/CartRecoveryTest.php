...
final class CartRecoveryTest extends TestCase
{
    ...
    public function test_render_substitutes_default_template_placeholders(): void
    {
        ...
        $result = \zignites_chat_render_cart_recovery_message($items, $total, $cart_url);
        ...
        // Currency symbol decoded by zignites_chat_currency_symbol_text():
    ...
    {
        $GLOBALS['zignites_chat_test_options']['zignites_chat_cart_recovery_message'] =
            'Items: {items}; Total: {total} {currency_symbol}; URL: {cart_url}';

        $result = \zignites_chat_render_cart_recovery_message(['•Foo'], '99.50', 'https://shop.test/c');
