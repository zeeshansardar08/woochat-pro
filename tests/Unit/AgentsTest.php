...
final class AgentsTest extends TestCase
{
    ...
    public function test_sanitize_drops_rows_with_blank_name_or_phone(): void
    {
        ...
        $sanitized = json_decode(\zignites_chat_sanitize_agents_json($input), true);
    ...
    {
        $this->assertSame('[]', \zignites_chat_sanitize_agents_json('not json'));
        $this->assertSame('[]', \zignites_chat_sanitize_agents_json(null));
        $this->assertSame('[]', \zignites_chat_sanitize_agents_json(['not', 'a', 'list', 'of', 'agents']));
    }
    ...
    public function test_get_agents_drops_malformed_persisted_rows(): void
    {
        ...
        $GLOBALS['zignites_chat_test_options']['zignites_chat_agents'] = wp_json_encode([
    ...
    {
        $this->assertSame('single', \zignites_chat_sanitize_agent_routing_mode('single'));
        $this->assertSame('random', \zignites_chat_sanitize_agent_routing_mode('random'));
        $this->assertSame('single', \zignites_chat_sanitize_agent_routing_mode('rotation'));
        $this->assertSame('single', \zignites_chat_sanitize_agent_routing_mode(''));
    }
}
