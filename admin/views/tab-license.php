        ...
        <tr>
            ...
            <td>
                ...
                <div style="margin-top:8px; display:flex; align-items:center; gap:12px;">
                    ...
                    <button type="button" class="button button-primary" id="wcwp-activate-license"><?php esc_html_e('Activate', 'woochat'); ?></button>
                    <button type="button" class="button" id="wcwp-deactivate-license"><?php esc_html_e('Deactivate', 'woochat'); ?></button>
                </div>
                <?php
                ...
                if ($expires) {
                    printf(
                        ...
                        esc_html( sprintf( /* translators: %s: license expiry date */ __( 'Expires: %s', 'woochat' ), $expires ) )
                    );
                }
                if ($message) {
